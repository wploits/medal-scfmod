...
impl fmt::Display for Statement {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Statement::ForIterate(r#for_iterate) => write!(f, "{}", r#for_iterate),
            Statement::ForPrep(r#for_prep) => write!(f, "{}", for_prep),
            Statement::NumericFor(r#numeric_for) => write!(f, "{}", numeric_for),
